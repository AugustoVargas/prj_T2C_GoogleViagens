...
class T2CProcess:
    ...
    def execute(self, arg_tplQueueItem:tuple):
        ...
        var_strPaisDestino = arg_tplQueueItem[1]
        # Preencher dados
        ...
        var_clssFuncoesGoogleViagens.selecionarIdaGoogleViagens()
        var_clssFuncoesGoogleViagens.selecionarSaida()
        var_clssFuncoesGoogleViagens.selecionarDestino(var_strPaisDestino)
        var_clssFuncoesGoogleViagens.selecionaPeriodo()
        var_clssFuncoesGoogleViagens.extraiInfosValores(var_strPaisDestino)

        var_clssFuncoesGoogleViagens.sortPassagensBaratas()
