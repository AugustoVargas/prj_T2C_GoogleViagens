...
class Bot(WebBot):
    ...
    def action(self, execution=None):
        ...
        var_strusuario = var_dictConfig["EmailUser"]
        var_strSenha = var_dictConfig["EmailSenha"]
        strEmailServerSmtp = var_dictConfig["EmailServerSmtp"]
        arg_intEmailPortaSmtp=var_dictConfig["EmailPortaSmtp"]

        var_clssSendEmail = T2CSendEmail(arg_strEmailServerSmtp=strEmailServerSmtp, arg_intEmailPortaSmtp=arg_intEmailPortaSmtp, arg_strUsuario=var_strusuario, arg_strSenha=var_strSenha,arg_strNomeProcesso=var_strNomeProcesso, arg_clssMaestro=var_clssMaestro)
        ...
        var_strCaminhoArquivoPassagens = var_dictConfig["strCaminhoArquivoPassagens"]
        var_strNomeArquivo = os.path.join(var_strCaminhoArquivoPassagens,"Passagens.xlsx")
        if(var_dictConfig["EmailFinal"].upper() == "SIM"):   
            var_clssSendEmail.send_email_final(arg_strHorarioInicio=var_strDatahoraInicio, arg_strHorarioFim=var_strDatahoraFim, arg_strEnvioPara=var_dictConfig["EmailDestinatarios"], arg_listAnexos=[var_strNomeArquivo], arg_boolSucesso=True)
